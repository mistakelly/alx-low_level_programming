 ...
 * @e_ident: this a  pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_entry: The is the  address of the ELF entry point.
 * @e_ident: the  pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main - it will  Displays the information contained in the
